          ...
          <div class="row">
            <div class="col-md-12">
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="/admin/create">Tambah Produk</a>
                </li>
              </ul>
            </div>
          </div>
               ...
               <div class="row justify-content-between">
                 ...
                 <div class="col-md-8">
                   <br>
                     <div class="form-group">
                       ...
                       @endif
                       <input type="text" name="nama_produk" class="form-control" id="nama_produk" placeholder="Masukkan Link ..." value="{{old('nama_produk')}}">
                     </div>
                     <div class="form-group">
                       ...
                       @endif
                       <textarea class="form-control" name="deskripsi_produk" id="deskripsi_produk" rows="17">{{old('deskripsi_produk')}}</textarea>
                     </div>
                 </div>
                 {{-- end kolom post --}}
                 ...
                 <div class="col-md-4">
                   ...
                   <div class="form-group">
                     ...
                     @endif
                     <input type="number" name="harga_produk" class="form-control" id="harga_produk" placeholder="Masukkan Harga Produk ..." value="{{old('harga_produk')}}">
                   </div>
                   <div class="form-group">
                   ...
                   <div class="form-group">
                     ...
                     <div class="input-group">
                       ...
                       <input id="thumbnail" class="form-control" type="text" name="gambar_produk" value="{{old('gambar_produk')}}" readonly>
                     </div>
                   </div>
                   <div class="row justify-content-md-center">
                     <div class="col-md-9">
                       <div class="featured_img_holder">
                         <img alt="{{old('nama_produk')}}" src="{{old('gambar_produk')}}" id="holder" style="margin-top:15px;min-height:170px;max-height:170px; max-width:245px">
                       </div>
                     </div>
                   </div>
                   <br>
